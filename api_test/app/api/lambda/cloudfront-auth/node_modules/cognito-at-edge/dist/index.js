...
class Authenticator {
    ...
    async _getRedirectResponse(tokens, domain, location) {
        ...
        const cookies = [
            cookie_1.Cookies.serialize(`${usernameBase}.accessToken`, tokens.access_token, cookieAttributes),
            cookie_1.Cookies.serialize(`${usernameBase}.idToken`, tokens.id_token, cookieAttributes),
            cookie_1.Cookies.serialize(`${usernameBase}.refreshToken`, tokens.refresh_token, cookieAttributes),
     ...
     */
    _getIdTokenFromCookie(cookieHeaders) {
